...
namespace margelo::nitro::nitroplayer {
  ...
  /**
   * An enum which can be represented as a JavaScript union (QueueOperation).
   */
...
namespace margelo::nitro {
  ...
  // C++ QueueOperation <> JS QueueOperation (union)
  template <>
  struct JSIConverter<margelo::nitro::nitroplayer::QueueOperation> final {
    static inline margelo::nitro::nitroplayer::QueueOperation fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, margelo::nitro::nitroplayer::QueueOperation arg) {
      switch (arg) {

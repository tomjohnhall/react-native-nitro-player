...
/**
 * Represents the JavaScript callback `(position: number, totalDuration: number) => void`.
...
fun interface Func_void_double_double: (Double, Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(position: Double, totalDuration: Double): Unit
}
...
class Func_void_double_double_cxx: Func_void_double_double {
  ...
  @Keep
  override fun invoke(position: Double, totalDuration: Double): Unit
    = invoke_cxx(position,totalDuration)

  @FastNative
  private external fun invoke_cxx(position: Double, totalDuration: Double): Unit
}
...
class Func_void_double_double_java(private val function: (Double, Double) -> Unit): Func_void_double_double {
  ...
  @Keep
  override fun invoke(position: Double, totalDuration: Double): Unit {
    return this.function(position, totalDuration)
  }
}

...
/**
 * Wraps a Swift `(_ position: Double, _ totalDuration: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double_double {
  public typealias bridge = margelo.nitro.nitroplayer.bridge.swift

  private let closure: (_ position: Double, _ totalDuration: Double) -> Void

  public init(_ closure: @escaping (_ position: Double, _ totalDuration: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(position: Double, totalDuration: Double) -> Void {
    self.closure(position, totalDuration)
  }
